		...
		foreach($res as $row)
			{
				$result[] = array(
							...
							'action'	=> '<button class="btn btn-primary edit" idcontent="'.$row->id_page.'"><i class="material-icons">create</i></button> <div class="btn btn-danger del" idcontent="'.$row->id_page.'">
