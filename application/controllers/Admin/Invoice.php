		...
		foreach($res as $row)
			{
				$result[] = array(
							...
							'action'	=> '<div id="delete" class="btn btn-danger" idaksesoris="'.$row->id_inv.'">
		...
		foreach($res as $row)
			{
				$result[] = array(
							...
							'date'		=> exDate($row->date_inv),
							'action'	=> '<div id="conf" class="btn btn-primary" idaksesoris="'.$row->id_inv.'">
							<i class="material-icons">done</i>
							</div> <div id="delete" class="btn btn-danger del" idaksesoris="'.$row->id_inv.'">
            					<i class="material-icons">delete</i></div>'
							);
			}
		...
		foreach($res as $row)
			{
				$result[] = array(
							...
							'price'		=> 'Rp. '.rpCurrency($row->total_inv),
							'date'		=> exDate($row->date_inv),
							'action'	=> '<div id="delete" class="btn btn-danger del" idaksesoris="'.$row->id_inv.'">
            					<i class="material-icons">delete</i></div>'
							);
			}
