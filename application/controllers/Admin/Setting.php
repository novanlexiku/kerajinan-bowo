		...
		foreach($res as $row)
			{
				$result[] = array(
							...
							'action'	=> '<button id="edit" class="btn btn-primary edit" idcontent="'.$row->id_bank.'"><i class="material-icons">create</i></button> <div id="delete" class="btn btn-danger" idcontent="'.$row->id_bank.'">
							<i class="material-icons">delete_sweep</i></div>'
							);
			}
