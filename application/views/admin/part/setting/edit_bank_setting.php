...
<form id="edittBankForm">
  <div class="input-group">
    <span class="input-group-addon"><i class="material-icons">apps</i></span>
    <input type="hidden" id='idbank' name="idbank" value="<?php echo $bd->id_bank;?>">
    <input id="title" type="text" class="form-control" name="aksesoris" value="<?php echo $bd->name_bank;?>" placeholder="Nama Bank" required="">
  </div>
  <br>

  <div class="input-group">
    <span class="input-group-addon"><i class="material-icons">apps</i></span>
    <input id="noAcc" type="number" class="form-control" value="<?php echo $bd->acc_bank;?>" name="aksesoris" placeholder="Nomor Rekening" required="">
  </div>
  <br>
  <div class="input-group">
