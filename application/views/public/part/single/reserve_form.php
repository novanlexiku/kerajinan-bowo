...
<div class="reserve-form" style="    width: 100%;
    ...
    <input type="hidden" name="idaksesoris" value="<?php echo $hd->id_aksesoris;?>">
    ...
    <div class="aksesoris-content-resreve">
    ...
    text-align: center;">Detail Pemesanan</label>
    	<div class="left" style="width: 150; display: inline-block; vertical-align: top;">
    		<img src="<?php echo base_url().'assets/hpublic/img_aksesoris/'.$hd->image;?>" style="    width: 150px;
    border-radius: 3px;
