...
$route['admin/aksesoris']	= 'admin/aksesoris';
$route['admin/tagihan'] 	= 'admin/invoice';
$route['admin/setting'] 	= 'admin/setting';
$route['admin/laporan_pemesanan'] 	= 'admin/laporan2';
...
$route['aksesoris']					= 'public/aksesoris';
$route['aksesoris/(:any)']  		= 'public/aksesoris/single_page/$1';
