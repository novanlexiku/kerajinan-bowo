...
class Minvoice extends CI_Model {
	...
	*/
	...
	{
		$query = $this->db->query('select * from tbl_invoice where status_inv="0"');
		return $query->result();
	}

	public function load_conf()
	{
		$query = $this->db->query('select * from tbl_invoice where status_inv="1"');
		return $query->result();
	}

	public function load_cancel()
	{
		$query = $this->db->query('select * from tbl_invoice where status_inv="9"');
		return $query->result();
	}
